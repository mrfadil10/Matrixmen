...
int	load_textures(t_main *game)
{
	...
	if (!game->texture[TXT_NO].addr)
		return (set_err_msg(game, "\e[0;31mFailed to reach north xpm."));
	...
	if (!game->texture[TXT_SO].addr)
		return (set_err_msg(game, "\e[0;31mFailed to reach south xpm."));
	...
	if (!game->texture[TXT_EA].addr)
		return (set_err_msg(game, "\e[0;31mFailed to reach east xpm."));
	...
	if (!game->texture[TXT_WE].addr)
		return (set_err_msg(game, "\e[0;31mFailed to reach west xpm."));
	return (0);
}
